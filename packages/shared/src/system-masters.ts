...
export const MASTER_PERMISSIONS: Record<MasterType, MasterPermissionRefs> = {
  ...
  [MASTER_TYPE.FAQ]: { viewPermission: PERMISSIONS.MASTER_FAQS_VIEW },
};
...
export const SYSTEM_ADMIN_PERMISSION_KEYS: readonly string[] = [
  ...
  PERMISSIONS.MASTER_FAQS_VIEW,
  PERMISSIONS.MASTER_FAQS_CREATE,
  PERMISSIONS.MASTER_FAQS_UPDATE,
  PERMISSIONS.MASTER_FAQS_DELETE,
];
